-- Data Cleaning
-- This script performs data cleaning on the layoffs dataset, including duplicate 
-- removal, standardization, and handling missing values.
...
-- Standardizing company names and country names by removing extra spaces and punctuation.
...
-- Convert date column from text format to DATE type
SELECT `date`,
